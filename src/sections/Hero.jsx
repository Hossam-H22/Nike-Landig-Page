...
export default function Hero() {
    ...
    return <>
        ...
        <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-cover">
            <img 
                src={bigShoeImg}
                alt="shoe collection"
            ...
            <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
                { shoes.map((shoe, index)=> <div key={index}>
                    <ShoeCard 
                        imgURL={shoe} 
